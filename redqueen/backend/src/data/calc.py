...
import logging
from calc_stock_indicators import daily_process_stock_indicators,daily_process_industry_indicators
...
# def calculate_price(engine, ma_window_1=config.MA_WINDOW_1, ma_window_2=config.MA_WINDOW_2, atr_window=config.ATR_WINDOW):
#     """
...
# def calculate_price_latest(engine, ma_window_1=config.MA_WINDOW_1, ma_window_2=config.MA_WINDOW_2, atr_window=config.ATR_WINDOW):
#     """
